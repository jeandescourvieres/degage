...
fun ManualScreen(onBack: () -> Unit) {
    Column(
        ...
        LazyColumn(
            ...
            item {
                ManualSection(
                    title = stringResource(R.string.manual_q34_title),
                    body = stringResource(R.string.manual_q34_body)
                )
            }
            item {
                ManualSection(
            ...
            item {
                ManualSection(
                    title = stringResource(R.string.manual_q36_title),
                    body = stringResource(R.string.manual_q36_body)
                )
            }
            item {
                ManualSection(
